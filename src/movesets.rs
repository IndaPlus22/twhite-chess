...
//TODO wrap all possible_move vectors to options and return Some(possible_moves)
...
pub fn black_pawn_possible_moves(i: i32) -> Option<Vec<i32>> {
    ...
    //Create a vector with potential foward moves to make
    let mut potential_forward_moves = i - 17;
    i + 8;
    i + 16;
    ...
    // TODO Moves forward can't capture
    ...
    // TODO Moves diagonally can capture
...
pub fn black_knight_possible_moves(i: i32) -> Option<Vec<i32>> {
    ...
    //TODO refactor the loop below ro use for king possible moves as well
    //and possibly pawn possible moves
